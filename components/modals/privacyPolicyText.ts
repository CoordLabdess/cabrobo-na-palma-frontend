export const privacyPolicyText = `Política de Privacidade do Cabrobó na Palma da Mão
...
Dados Pessoais: CEP/código postal; cidade; endereço físico; estado; município; nome; número de telefone; país; sobrenome
...
Av. Gov. Agamenon Magalhães - Santo Amaro, Recife - PE, 50100-010

Prefeitura Municipal de Cabrobó-PE
Praça José Caldas Cavalcanti - Centro, Cabrobó - PE, 56180-000

E-mail de contato do Proprietário: coord_labdess@poli.br
...
Entre os tipos de Dados Pessoais que este Aplicativo coleta, por si mesmo ou através de terceiros, existem: nome; sobrenome; número de telefone; endereço físico; país; estado; município; CEP/código postal; cidade; posição geográfica.
