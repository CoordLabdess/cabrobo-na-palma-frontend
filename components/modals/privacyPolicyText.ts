export const privacyPolicyText = `Política de Privacidade do Recicla Cabrobó
...
Dados Pessoais: CEP/código postal; cidade; data de nascimento; endereço físico; estado; ID do Usuário; município; nome; sexo; sobrenome
...
Entre os tipos de Dados Pessoais que este Aplicativo coleta, por si mesmo ou através de terceiros, existem: nome; sobrenome; sexo; data de nascimento; endereço físico; estado; município; CEP/código postal; cidade; ID do Usuário.
